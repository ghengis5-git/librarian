---
template_id: bug-bounty-report
display_name: Bug Bounty Report
preset: security
description: >-
  Structured vulnerability disclosure report for bug bounty submissions.
  Follows HackerOne/Bugcrowd best practices with CVSS 3.1 scoring, CWE
  classification, clear reproduction steps, proof of concept, and impact
  assessment. Designed for researcher submissions to maximize triage speed
  and bounty outcomes.
suggested_tags: [security, bug-bounty, disclosure, vulnerability]
...
*Document generated by librarian v{{librarian_version}} from template `bug-bounty-report`.*
